// src/templates/template45.ts

export const template45 = `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8" />
  <title>Bold Blue CV</title>
  <link href="https://fonts.googleapis.com/css2?family=Barlow:wght@500;700&family=Roboto:wght@400;500;700&display=swap" rel="stylesheet">
  <style>
    body {
      margin: 0;
      padding: 0;
    ...
    .top-header {
      ...
      color: #fff;
      border-bottom: 5px solid #003f80;
    }
    .top-left h1 {
