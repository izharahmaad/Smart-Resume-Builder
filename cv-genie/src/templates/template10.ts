...
<head>
  <meta charset="utf-8" />
  <title>Frontend Developer CV</title>
  ...
  <style>
    ...
    .header {
      ...
      box-shadow: 0 0 8px rgba(183, 140, 255, 0.3);
    }
    .profile-image {
      width: 100px;
      height: 100px;
      ...
      margin-bottom: 12px;
      border: 2px solid #b78cff;
      box-shadow: 0 0 6px rgba(183, 140, 255, 0.5);
    }
    .header h1 {
      font-size: 30px;
      margin: 8px 0 4px 0;
    ...
    .skill {
      ...
      box-shadow: 0 0 4px rgba(183, 140, 255, 0.3);
    }
    .footer {
      text-align: center;
      margin-top: 20px;
